...
class User(BaseModel):
    ...
    username = CharField(index=True, unique=True,max_length=16, verbose_name =
                         '学号')
    openid = CharField(unique=True, max_length=32, verbose_name = '微信openid')
    nickname = CharField(max_length=16, verbose_name = '姓名')
    major = CharField(max_length=16, verbose_name = '专业')
    type = IntegerField(choices=STUTYPE, default=1,
                           verbose_name="学生类型")
    passwd = CharField(max_length=32, verbose_name='教务系统密码')
    ...
    # 创建新的用户
    @staticmethod
    def new(username, nickname, major, passwd, type, openid, password):
        salt = random_str()
